...
//       state.playerStateController.state.current!.cacheCoverPath,
//     );
//     return ClipRRect(
...
//             ? AudioThumbnail(file: state.playerStateController.state.current!)
...
//     return Text(state.playerStateController.state.current!.autoTitle);
//   }
...
//       tooltip: 'Shuffle',
//       onPressed: () {
//         state.playerStateController.actions.toggleShuffle();
//       },
//       icon: StreamBuilder(
//         stream: state.playerStateController.stream.shuffle,
//         builder: (context, asyncSnapshot) {
//           final isShuffle = state.playerStateController.state.isShuffle;
//           return Container(
